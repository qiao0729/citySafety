        ...
        <el-dropdown hide-on-click>
          <div class="menu_title">
            ...
            <span class="el-dropdown-link"
              >事故灾难<i class="el-icon-arrow-down el-icon--right"></i
            ></span>
          </div>
...
export default {
  ...
  methods: {
    ...
    lastChar() {
      var lastChar = this.$echarts.init(document.getElementById("divPlugin2"));
    ...
    MarkerClick(marker) {
      ...
      for (var i = 0; i < 1; i++) {
        that.startRealPlay(
          szDeviceIdentify,
          chooseSz,
          that.hkvInfo.channels[cameraId]
        );
      }
    ...
    clickStartRealPlay() {
      ...
      var j =
        that.hkvInfo.channels.length > windNum
          ? windNum
    ...
    clickStopRealPlay: function () {
      ...
      var j =
        this.hkvInfo.channels.length > windNum
          ? windNum
          : this.hkvInfo.channels.length;
      for (var i = 0; i < j; i++) {
